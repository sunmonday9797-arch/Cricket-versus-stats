...
def calculate_smart_rankings(df_all):
    ...
    # Normalize SBR to clean 0-100 scale
    ...
    # --- SBO (Smart Bowling Ratings) - FIX APPLIED TO PREVENT KEYERRORS ---
    sbo_df = df_calc.groupby('Bowler').agg(
    ...
    # Normalize SBO to clean 0-100 scale
    ...
    # --- MVP (Most Valuable Player Ratings) ---
